...
export default function TemplatesPage() {
  ...
  const handleProfessionalTemplates = () => {
    router.push("/professional-templates")
  }
    ...
    <TooltipProvider>
      <div className="container mx-auto py-8 px-6">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          {/* Professional Templates Reference Button */}
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                variant="outline"
                onClick={handleProfessionalTemplates}
            ...
            <TooltipContent>
              <p>Go through some professional resumes which are attached for your reference</p>
            </TooltipContent>
          </Tooltip>
        </div>
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Select a template that best represents your professional style. Each template offers a unique design
            approach within its category.
          </p>
        </div>
                  ...
                  <Card key={template.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                    <CardContent className="p-0">
                      <div className="relative h-64 bg-gray-50">
                        {renderTemplateThumbnail(category.id, template.id)}
                      </div>
                      <div className="p-4">
                        <div className="mb-2">
